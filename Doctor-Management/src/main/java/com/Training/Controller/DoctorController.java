...
public class DoctorController {
	 @Autowired
      ...
      public List<Doctor> getAllDoctor(){
	   ...
	   @GetMapping("/doc/{id}/book")
	    public Optional<Doctor> bookDoctor(@RequestBody Doctor doctor,@PathVariable int id) {
	    	
	    	Doctor doctor2 = docService.BookAppointment(doctor,id);
